...
describe('[TC1004]', () => {
  ...
  it('Ttitle : Verify default language and changes after changing language', () => {
    ...
    desktopLoginPageObjects.verifyDashboard(tcCommonData.dashboardCheck);
    ...
    desktopLoginPageObjects.clickLanguageButton(tcCommonData.defaultLanguage);
    ...
    desktopLoginPageObjects.changeLanguage(tcCommonData.defaultLanguage);
    cy.wait(3000);
    //signout
    desktopLoginPageObjects.logout();
